	...
	<div class="cl inner_wrap center">
		...
		<?php elseif($my['admin']==1 && !$_temp['best']):?><br>현재 보유 팬 순(자동)으로 멘토가 출력중입니다.<br><br>
			...
			<div class="cl" style="margin: 20px 0; display: none;" data-toggle="mentorSetting">
				<style>
					ul#mentor_selects {margin: 20px auto; width: 600px; overflow: hidden;}
					ul#mentor_selects > li {display: inline-block; width: 150px; float: left; text-align: left; text-overflow:ellipsis;white-space:nowrap;word-wrap:normal; overflow: hidden;}
				</style>
...
<div class="cl" style="padding: 20px 0 20px 0;">
	...
	<div class="cl inner_wrap center" style="padding: 20px 0; width: 900px;">
		<?php if($_RNum2):?>
