...
?>
<div class="cl" style="margin-bottom: 70px; line-height: 24px;">
<h2>멘토 인터뷰</h2>
<?php if($Interview['media_key']):?>
	<div class="center">
		<iframe width="100%" height="500" src="http://play.smartucc.kr/player.php?origin=<?=$Interview['media_key']?>" frameborder="0" allowfullscreen></iframe>
	</div>
<?php endif; ?>
	...
	<br><?php if($Interview['i_pic']):?><img src="/_var/iphoto/<?=$Interview['i_pic']?>" style="max-height: 400px; margin-top: 30px;"><?php endif; ?>
</div>
