<link rel="stylesheet" href="/static/swiper.css">
		<article class="d_sub_midcell cl white" style="background-color: #4f9cd0">
			<div class="cl inner_wrap" style="height:160px; padding:20px 0; ">
				<div class="fl""><img src="<?=$g['img_layout']?>/apply_head.png" width="100" height="131" alt="수강신청"></div>
				<div class="fl" style="padding-left:20px;"><span class="htitle">꿈을 찾을 때 까지<br>멘토를 만나라</span><br><span class="htitle3">나와 같은 고민을 했던 멘토,<br> 해답은 그들에게 있다. <br> 길을 찾을 때까지 만나라. <br><span class="br"></span> 해답은 분명히 그곳에 있다.</span></div>
			</div>
		</article>
		<article>
			<div id="d_main_appling" class="inner_wrap cl">	
				...
				<div id="d_main_search" class="cl">
					<div>
						...
						<div class="cl" style="width: 252px; margin: 0 auto 5px auto;">
							<select name="sort" id="sort" class="btngray" onchange="apply_search();" style="width: 123px; margin-right: 2px;">
								<option value="">최근등록순</option>
								<option value="date_end|asc"<?if($sort == "date_end|asc"):?> selected<?endif;?>>신청마감순</option>
							</select>
							<select name="search" id="search" class="btngray" style="width: 123px;">
						...
						<div class="cl" style="width: 252px; margin: 0 auto 20px auto;">
							<input type="text" name="keyword" class="btngray" value="<?=$keyword?>" placeholder="키워드 입력" style="width: 174px; height: 28px; line-height: 28px;">
							<input type="submit" class="btnblue" value="검색" onclick="apply_search();" style="">
