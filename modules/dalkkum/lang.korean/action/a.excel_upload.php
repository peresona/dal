...
require_once($_SERVER['DOCUMENT_ROOT']."/_core/outlib/PHPExcel.php");
require_once($_SERVER['DOCUMENT_ROOT']."/_core/outlib/PHPExcel/MyReadFilter.php");
