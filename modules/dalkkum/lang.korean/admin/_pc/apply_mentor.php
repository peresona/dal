...
function getMDname($id)
{
	...
	$_WHERE .= '(mentor_apply is not null) and not(mentor_apply="") and not(mentor_confirm="Y")';
...
<?php endif?>
	...
	<?php if(!$NUM):?>
	<div class="nodata"><img src="<?php echo $g['img_core']?>/_public/ico_notice.gif" alt="" /> 멘토를 신청한 회원이 없습니다.</div>
	<?php endif?>
