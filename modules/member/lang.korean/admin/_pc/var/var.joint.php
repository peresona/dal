...
<div id="mjointbox">
	...
	<div class="title">
		회원관리 모듈은 <span class="b">회원가입/로그인/My page</span>를 포함하고 있습니다.<br />
		연결할 페이지를 선택해 주세요.
	</div>
	...
	<input type="button" value="My page" class="btnblue" onclick="dropJoint('<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $smodule?>&front=mypage');" />
