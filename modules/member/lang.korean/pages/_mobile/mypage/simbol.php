...
<div id="pages_join">
	...
	<div class="upload">
		...
		<span>( gif / jpg / png - 가로 800픽셀, 세로 600픽셀 미만)</span>
	</div>
	<div class="cl center" style="margin:20px 0;"><input type="submit" value="사진등록" class="btngray" /></div>
