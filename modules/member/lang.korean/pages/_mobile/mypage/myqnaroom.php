...
<div class="myqna">
	...
	<table summary="나의 QnA 게시판 질문 리스트입니다." data-inhtml="qna">
	...
	<tr>
	<td class="sbj">
		<a href="/mblog/qna/?mentor=<?=$R['mentorUID']?>&uid=<?=$R['uid']?>"><?php echo getStrCut2($R['subject'],'15','')?></a>
	...
	<?php elseif($NUM>20):?>
	<tr class="cp" onclick="myQnaMoreList(this, 'qna', 20, 20);"><td colspan="3" class="center">더보기</td></tr>
	<?php endif?>
	</tbody>
	</table>
...
<div class="myqna">
	...
	<h2><?=getJobName($my['mentor_job'])?> 진로 QnA</h2>
	...
	<tr>
	<td class="sbj">
		<a href="/jblog/kin/?job=<?=$R['jobUID']?>&uid=<?=$R['uid']?>"><?php echo getStrCut2($R['subject'],'15','')?></a>
	...
	<?php if(!$NUM):?>
	<tr>
	<td class="sbj1" colspan="2" align="center">내가 한 질문이 없습니다.</td>
	</tr> 
	<?php elseif($NUM>20):?>
	<tr class="cp" onclick="myQnaMoreList(this, 'kin', 20, 20);"><td colspan="2" class="center">더보기</td></tr>
	<?php endif?>
	</tbody>
	</table>
