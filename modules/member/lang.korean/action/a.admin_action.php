...
foreach ($MEMBERS as $M)
{
	...
	if ($act == 'mentor_apply')
	{
		getDbUpdate($table['s_mbrdata'],'mentor_apply=NULL','memberuid='.$M['memberuid']);
		getDbUpdate($table['s_mbrdata'],'mentor_confirm="Y"','memberuid='.$M['memberuid']);
	}
	//멘토 지원 거절
	if ($act == 'mentor_refuse')
	{
		getDbUpdate($table['s_mbrdata'],'mentor_job=NULL','memberuid='.$M['memberuid']);
		getDbUpdate($table['s_mbrdata'],'mentor_apply=NULL','memberuid='.$M['memberuid']);
		getDbUpdate($table['s_mbrdata'],'mentor_confirm=NULL','memberuid='.$M['memberuid']);
	}
	//멘토해제
	if ($act == 'mentor_delete')
	{
		getDbUpdate($table['s_mbrdata'],'mentor_job=NULL','memberuid='.$M['memberuid']);
		getDbUpdate($table['s_mbrdata'],'mentor_apply=NULL','memberuid='.$M['memberuid']);
		getDbUpdate($table['s_mbrdata'],'mentor_confirm=NULL','memberuid='.$M['memberuid']);
