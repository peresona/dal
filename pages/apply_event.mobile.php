		...
		<?php endif; ?>
			...
			<div class="join_cl">
				<div class="cl"> <font class="black">교육 장소</font><br> </div>
					...
					<input type="text" id="a_address" name="a_address" class="d_form_underline" style="width: 100%;" value="<?=$a_address?>"><br>
					<input type="text" id="a_address_detail" name="a_address_detail" class="d_form_underline" style="width: 100%;" placeholder="상세주소"
